        ...
        if (smtpSocket != null && out != null && in != null) {
            try {
                ...
                */
                ...
                /*
                STEP 2 The client initiates its dialog by responding with a HELLO command identifying itself
                */
                ...
                */
                ...
                out.println("MAIL From: russel@russel.com");
                while ((responseLine = in.readLine()) != null) {
                    System.out.println("Server: " + responseLine);
                    if (responseLine.indexOf("250") != -1) {
                        break;
                ...
                */
                ...
                out.println("RCPT TO: blessedrtchitambira@gmail.com");
                ...
                */
                ...
                out.println("From: russel@russel.com");
                out.println("To: blessedrtchitambira@gmail.com");
                ...
                out.println("Hello from the other side"); // message body
                out.println();
                out.println(".");
                //out.println();
